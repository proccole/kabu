...
pub fn new_op_node_block_workers_starter<P>(
    client: P,
    new_block_headers_channel: Option<Broadcaster<MessageBlockHeader<KabuDataTypesOptimism>>>,
    new_block_with_tx_channel: Option<Broadcaster<MessageBlock<KabuDataTypesOptimism>>>,
    new_block_logs_channel: Option<Broadcaster<MessageBlockLogs<KabuDataTypesOptimism>>>,
    new_block_state_update_channel: Option<Broadcaster<MessageBlockStateUpdate<KabuDataTypesOptimism>>>,
) -> ActorResult
where
